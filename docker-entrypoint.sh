...
keytool -v -importkeystore -deststorepass $keystorePassword -destkeystore $keystoreLocation -deststoretype JKS -srckeystore tomcat.p12 -srcstoretype PKCS12 --noprompt
